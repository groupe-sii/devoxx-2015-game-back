...
public class SpriteImageTest {
	...
	public void folder() throws IOException, MimetypeDetectionException {
		Sprite sprite = new SpriteBase("images/immobilize");
	...
	public void base64Images() throws IOException, MimetypeDetectionException {
		Sprite sprite = new SpriteBase(new Base64ServerImage("images/immobilize/1.png"), new Base64ServerImage("images/immobilize/2.png"));
	...
	public void uriImages() throws IOException, MimetypeDetectionException, URISyntaxException {
		Sprite sprite = new SpriteBase(new UriImage("images/immobilize/1.png"), new UriImage("images/immobilize/2.png"));
		Assert.assertEquals("sprite size should be 68x32", new Dimension(68, 32), new Dimension(sprite.getWidth(), sprite.getHeight()));
		Assert.assertEquals("sprite frrame size should be 34x32", new Dimension(34, 32), new Dimension(sprite.getFrameWidth(), sprite.getFrameHeight()));
	}
