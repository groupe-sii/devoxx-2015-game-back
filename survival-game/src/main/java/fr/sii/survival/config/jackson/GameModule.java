...
import fr.sii.survival.config.jackson.mixin.UpdatePositionMixin;
import fr.sii.survival.config.jackson.mixin.UpdateStatesMixin;
...
public class GameModule extends SimpleModule {
	...
	public void setupModule(SetupContext context) {
		...
		context.setMixInAnnotations(UpdatePosition.class, UpdatePositionMixin.class);
		context.setMixInAnnotations(UpdateStates.class, UpdateStatesMixin.class);
